# sample-static-python

**One repo: static frontend + Python (FastAPI) API.**
...
op build-push
docker run -p 8081:8080 sample-static-python-api
docker run -p 8080:8080 -e PORT=8080 sample-static-python-frontend
```
